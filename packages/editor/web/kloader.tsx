...
// kymo brand loader (the animated "K"). Used for onboarding moments — the
// Welcome screen while a signed-in user's diagrams load. Pane-level loading
// (code/preview) uses the slimmer VS Code-style progress bar instead.
