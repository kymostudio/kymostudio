...
- **[The `.kymo` Language](/reference/dsl)** — learn every building block.
- **[Cookbook](https://github.com/kymostudio/kymostudio/blob/main/docs/guide/cookbook.md)** — start from a complete, real-world diagram.
