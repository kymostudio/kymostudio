...
1. Object Management Group. *Business Process Model and Notation (BPMN), Version 2.0.2.* OMG, 2014. [https://www.omg.org/spec/BPMN/](https://www.omg.org/spec/BPMN/) · PDF: [https://www.omg.org/spec/BPMN/2.0.2/PDF](https://www.omg.org/spec/BPMN/2.0.2/PDF)
2. ISO/IEC 19510:2013 — *Information technology — Object Management Group Business Process Model and Notation.* (Based on OMG BPMN 2.0.1.) [https://www.iso.org/standard/62652.html](https://www.iso.org/standard/62652.html)
...
5. Camunda. *BPMN 2.0 Symbols — A complete guide with examples.* [https://camunda.com/bpmn/reference/](https://camunda.com/bpmn/reference/)
6. Visual Paradigm. *BPMN guides — gateway types; orchestration vs choreography vs collaboration.* [https://www.visual-paradigm.com/guide/bpmn/](https://www.visual-paradigm.com/guide/bpmn/)
7. Lucidchart. *BPMN Symbols & Notation explained.* [https://www.lucidchart.com/pages/tutorial/bpmn-symbols-explained](https://www.lucidchart.com/pages/tutorial/bpmn-symbols-explained)
8. bpmn.io — open-source BPMN tooling (`bpmn-js`). [https://bpmn.io/](https://bpmn.io/)
