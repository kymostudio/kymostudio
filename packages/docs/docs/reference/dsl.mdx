...
[`samples/data.kymo`](https://raw.githubusercontent.com/kymostudio/kymostudio/main/samples/data.kymo)):
...
- **[Cookbook](https://github.com/kymostudio/kymostudio/blob/main/docs/guide/cookbook.md)** — complete diagrams you can adapt.
