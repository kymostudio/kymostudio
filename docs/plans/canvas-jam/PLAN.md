...
**Next:** **Phase 2 — Undo/redo** (`FR-J-02`, 8 SP): a history stack over the store's tags; undo
restores node `x/y` and `Board` writeback re-patches the `.kymo` text (`RK-EN-02`, `TC-18`/`TC-J-02`).
