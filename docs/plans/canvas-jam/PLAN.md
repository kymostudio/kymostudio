...
**Next:** **Phase 5 — Draw** (`FR-J-05`, 8 SP): the first freeform tool (pen/freedraw shape + tool
state machine), tagged outside `meta.kymo` so it never leaks into `.kymo`. Begins un-deferring `TC-06`
(`RK-EN-03`: one freeform tool per phase — draw, then sticky P6, then text P7).
