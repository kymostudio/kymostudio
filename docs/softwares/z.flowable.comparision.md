...
These follow from the comparison and the borrowable ideas catalogued in [`flowable.md`](z.flowable.md):
...
- Factual basis for the Flowable column: [`flowable.md`](z.flowable.md).
