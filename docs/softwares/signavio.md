...
| Related Documents | [`signavio.comparision.md`](./signavio.comparision.md), [`bpmn/README.md`](../diagrams/bpmn/README.md), [`KYMO_DSL.md`](../KYMO_DSL.md), [`BEST_PRACTICE_DIAGRAMS.md`](../BEST_PRACTICE_DIAGRAMS.md) |
