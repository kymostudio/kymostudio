...
| Related Documents | [`jbpm.comparision.md`](./z.jbpm.comparision.md), [`bpmn/README.md`](../diagrams/bpmn/README.md), [`activiti.md`](./z.activiti.md), [`kymo-dsl/`](../formats/kymo-dsl/README.md) |
...
The opinionated prior-art comparison — at-a-glance matrix, headline tradeoffs, a per-category scoring of jBPM against kymo, and open questions for kymo — lives in [`jbpm.comparision.md`](z.jbpm.comparision.md). It is kept separate so it can evolve at a different cadence than this factual reference (kymo changes alone are enough to invalidate it, even when upstream jBPM has not moved).
