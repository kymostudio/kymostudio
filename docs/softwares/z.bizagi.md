...
| Related Documents | [`bizagi.comparision.md`](./z.bizagi.comparision.md), [`bpmn/README.md`](../diagrams/bpmn/README.md), [`kymo-dsl/`](../formats/kymo-dsl/README.md), [`best-practices.md`](../diagrams/best-practices.md) |
...
The opinionated prior-art comparison — at-a-glance matrix, headline tradeoffs, a per-category scoring of Bizagi Modeler against kymo, and open questions for kymo — lives in [`bizagi.comparision.md`](z.bizagi.comparision.md). It is kept separate so it can evolve at a different cadence than this factual reference (kymo changes alone are enough to invalidate it, even when upstream Bizagi Modeler has not moved).
