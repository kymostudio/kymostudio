...
1. **How tightly should guidance track behaviour?** VP's strength is guidance embedded with the tool; kymo's `kymo-dsl/` and `BEST_PRACTICE_DIAGRAMS.md` should stay close enough to implementation that they never drift into aspiration.
