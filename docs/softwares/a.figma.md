...
| Related Documents | [`figma.comparision.md`](./a.figma.comparision.md), [`kymo-dsl/`](../formats/kymo-dsl/README.md), [`best-practices.md`](../diagrams/best-practices.md), [`d2.md`](./b.d2.md) |
...
The opinionated prior-art comparison — at-a-glance matrix, headline tradeoffs, a per-category scoring of Figma against kymo, and open questions for kymo — lives in [`figma.comparision.md`](a.figma.comparision.md). It is kept separate so it can evolve at a different cadence than this factual reference (kymo changes alone are enough to invalidate it, even when upstream Figma has not moved).
