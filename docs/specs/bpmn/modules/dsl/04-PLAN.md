...
Changes to the baselined spec (`docs/specs/bpmn/modules/dsl/`) are raised, assessed, and logged in
...
Version-controlled at `docs/specs/bpmn/modules/dsl/04-PLAN.md`; authoritative source is
