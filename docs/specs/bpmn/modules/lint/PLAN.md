...
supersedes: null
related_documents:
  - PROD-BPMN-LINT-001    # Product / stakeholder needs
...
| Owner        | `packages/python` (kymo CLI)                       |
| Related      | PROD-BPMN-LINT-001, INTRO-BPMN-LINT-001, FEAT-BPMN-LINT-001, DESIGN-BPMN-LINT-001, TEST-BPMN-LINT-001 |

Concept: INTRO-BPMN-LINT-001. Stakeholder needs: PROD-BPMN-LINT-001. Requirements (FR/NFR):
FEAT-BPMN-LINT-001. Design: DESIGN-BPMN-LINT-001. Verification: TEST-BPMN-LINT-001.
...
Version-controlled at `docs/specs/bpmn/modules/lint/PLAN.md`; authoritative source is the
