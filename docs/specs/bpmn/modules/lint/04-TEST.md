...
supersedes: null
related_documents:
  - PROD-BPMN-LINT-001      # Stakeholder needs (SN-LINT-NN)
  - INTRO-BPMN-LINT-001     # Introduction / scope
...
| Owner       | `packages/python` (kymo CLI)                                      |
| Related     | PROD-BPMN-LINT-001, INTRO-BPMN-LINT-001, FEAT-BPMN-LINT-001, DESIGN-BPMN-LINT-001, PLAN-BPMN-LINT-001 |
...
Version-controlled at `docs/specs/bpmn/modules/lint/04-TEST.md`; the authoritative source is the
