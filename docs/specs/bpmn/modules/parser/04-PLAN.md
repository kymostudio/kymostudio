...
Changes to the baselined spec (`docs/specs/bpmn/modules/parser/`) are raised, assessed, and logged in
...
Version-controlled at `docs/specs/bpmn/modules/parser/04-PLAN.md`; authoritative source is the
