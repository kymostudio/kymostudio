...
- **Change management:** a change to this baselined spec is raised as a change-request in
  `docs/specs/bpmn/modules/parser/CR/` and re-baselined (bump version + record in Annex A).
...
Version-controlled at `docs/specs/bpmn/modules/parser/01-REQUIREMENTS.md`; the
