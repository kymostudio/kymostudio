...
| Status            | **Open** |
| Owner             | `diagrams/` project |
| Related Documents | `INTRO-BPMN-ANIMATE-002`, `FEAT-BPMN-ANIMATE-002`, `DESIGN-BPMN-ANIMATE-002`, `TEST-BPMN-ANIMATE-002`, `PLAN-BPMN-ANIMATE-001` (parent), `KYMOANIM-MAP-001` (format) |
