...
| Status            | **Open** |
| Owner             | `diagrams/` project |
| Related Documents | `INTRO-BPMN-ANIMATE-002` (change record), `DESIGN-BPMN-ANIMATE-002` (how), `TEST-BPMN-ANIMATE-002` (V&V), `FEAT-BPMN-ANIMATE-001` (baselined SRS + needs), `KYMOANIM-MAP-001` (the format) |
