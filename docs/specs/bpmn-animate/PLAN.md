...
| Owner        | `diagrams/` project                                |
| Related      | INTRO-BPMN-ANIMATE-001, FEAT-BPMN-ANIMATE-001, DESIGN-BPMN-ANIMATE-001, TEST-BPMN-ANIMATE-001, KYMOANIM-MAP-001 |

Concept: INTRO-BPMN-ANIMATE-001. Requirements (FR/NFR): FEAT-BPMN-ANIMATE-001. Design:
...
Increments and any later changes to the baselined spec (`docs/specs/bpmn-animate/`) are raised,
...
Version-controlled at `docs/specs/bpmn-animate/PLAN.md`; authoritative source is the main-branch
