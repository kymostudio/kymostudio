...
| Owner             | `diagrams/` project |
| Related Documents | `INTRO-BPMN-ANIMATE-004` (change record), `FEAT-BPMN-ANIMATE-001` (parent SRS), `FEAT-BPMN-ANIMATE-002` (the descriptor consumed), `KYMOANIM-MAP-001` (format), `PROD-BPMN-ANIMATE-001` (needs) |
