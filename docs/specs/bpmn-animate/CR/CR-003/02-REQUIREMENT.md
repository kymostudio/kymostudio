...
| Owner             | `diagrams/` project |
| Related Documents | `INTRO-BPMN-ANIMATE-003` (change record), `FEAT-BPMN-ANIMATE-001` (parent SRS), `FEAT-BPMN-ANIMATE-002` (the descriptor + SVG this extends), `KYMOANIM-MAP-001` (format), `PROD-BPMN-ANIMATE-001` (needs) |
