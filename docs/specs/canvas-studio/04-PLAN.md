...
| 0.4     | 2026-05-25 | Vũ Anh | **Renumber for reading order.** Renamed `PLAN.md` → `06-PLAN.md` and `CR/` → `07-CR/`, extending the folder's `NN-` numbering to the living-plan layer; updated the §9 change-request links. `PLAN-STUDIO-001` unchanged. See `FEAT-STUDIO-001` §2. |
...
| 0.6     | 2026-05-28 | Vũ Anh | **Restructure to repo-norm layout.** Renamed `06-PLAN.md` → un-numbered `PLAN.md` (matches the repo's leaf model); `CHANGE-REQUESTS/` links unchanged; `PLAN-STUDIO-001` content unchanged. See `FEAT-STUDIO-001` Annex A 0.4. |
