...
| Owner        | `diagrams/` project                                |
| Related      | FEAT-DRAWIO-SVG-001, FEAT-DRAWIO-SVG-001, DESIGN-DRAWIO-SVG-001, TEST-DRAWIO-SVG-001 |

Concept: FEAT-DRAWIO-SVG-001. Requirements (FR/NFR): FEAT-DRAWIO-SVG-001. Design:
