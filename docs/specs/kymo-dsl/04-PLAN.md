...
supersedes: null
related_documents:
  - FEAT-KYMO-DSL-001       # Introduction
...
| Owner        | `diagrams/` project                                |
| Related      | FEAT-KYMO-DSL-001, DESIGN-KYMO-DSL-001, TEST-KYMO-DSL-001 |

Concept: FEAT-KYMO-DSL-001. Requirements (FR/NFR referenced below):
...
The plan is informative; the normative surface is FEAT-KYMO-DSL-001 and DESIGN-KYMO-DSL-001. Reconcile any deviation
