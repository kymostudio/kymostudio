...
| Owner        | `diagrams/` project                                |
| Related      | FEAT-BPMN-EXPORT-001, DESIGN-BPMN-EXPORT-001, PLAN-BPMN-EXPORT-001 |
...
Version-controlled at `docs/specs/format-bpmn/modules/export/03-TEST.md`; authoritative source is
