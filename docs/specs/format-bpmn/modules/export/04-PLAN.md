...
| Owner        | `diagrams/` project                                |
| Related      | FEAT-BPMN-EXPORT-001, DESIGN-BPMN-EXPORT-001, TEST-BPMN-EXPORT-001 |

Requirements (concept + FR/NFR referenced below): FEAT-BPMN-EXPORT-001.
Design: DESIGN-BPMN-EXPORT-001. Verification: TEST-BPMN-EXPORT-001.
...
Changes to the baselined spec (`docs/specs/format-bpmn/modules/export/`) are raised, assessed, and logged in
...
Version-controlled at `docs/specs/format-bpmn/modules/export/04-PLAN.md`; authoritative source is
