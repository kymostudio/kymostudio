...
| Owner        | `diagrams/` project                                |
| Related      | FEAT-BPMN-PARSER-001, DESIGN-BPMN-PARSER-001, PLAN-BPMN-PARSER-001 |
...
Version-controlled at `docs/specs/format-bpmn/modules/parser/03-TEST.md`; authoritative source is
