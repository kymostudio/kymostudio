...
| Owner        | `diagrams/` project                                |
| Related      | FEAT-BPMN-DSL-001, DESIGN-BPMN-DSL-001, PLAN-BPMN-DSL-001 |
...
Version-controlled at `docs/specs/format-bpmn/modules/dsl/03-TEST.md`; authoritative source
