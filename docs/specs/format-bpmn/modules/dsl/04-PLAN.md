...
| Owner        | `diagrams/` project                                |
| Related      | FEAT-BPMN-DSL-001, DESIGN-BPMN-DSL-001, TEST-BPMN-DSL-001 |

Concept and requirements (FR/NFR referenced below): FEAT-BPMN-DSL-001.
Design: DESIGN-BPMN-DSL-001. Verification: TEST-BPMN-DSL-001.
...
Changes to the baselined spec (`docs/specs/format-bpmn/modules/dsl/`) are raised, assessed, and logged in
...
Version-controlled at `docs/specs/format-bpmn/modules/dsl/04-PLAN.md`; authoritative source is
