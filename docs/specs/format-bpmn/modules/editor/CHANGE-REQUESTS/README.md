...
Change-requests against the (to-be-)baselined `bpmn-editor` spec (`docs/specs/format-bpmn/modules/editor/`). Each CR
is a **self-contained mini engineering-spec** in a `CR-NNN/` folder (`01-INTRO` → `02-REQUIREMENT` →
`03-DESIGN` → `04-TEST` → `05-PLAN`), scoped to one change — the
...
|----|--------|-------|------|--------|------|
| `CR-BPMN-EDITOR-001` | [`CR-001/`](CR-001/01-REQUIREMENTS.md) | Pools / participants & lanes (the laning model) | Enhancement | **Proposed** | 2026-05-31 |
| `CR-BPMN-EDITOR-002` | [`CR-002/`](CR-002/01-REQUIREMENTS.md) | "Set color" action (element recolor + DI color round-trip) | Enhancement | **Proposed** | 2026-05-31 |
| `CR-BPMN-EDITOR-003` | [`CR-003/`](CR-003/01-REQUIREMENTS.md) | Live BPMN validation / lint overlay | Enhancement | **Proposed** | 2026-05-31 |
| `CR-BPMN-EDITOR-004` | [`CR-004/`](CR-004/01-REQUIREMENTS.md) | Copy / paste, duplicate & keyboard modeling | Enhancement | **Proposed** | 2026-05-31 |
| `CR-BPMN-EDITOR-005` | [`CR-005/`](CR-005/01-REQUIREMENTS.md) | One-click auto-layout for hand-drawn diagrams | Enhancement | **Proposed** | 2026-05-31 |
