...
Later changes to the spec (`docs/specs/format-bpmn/modules/lint/`) are raised, assessed, and logged in
...
Version-controlled at `docs/specs/format-bpmn/modules/lint/04-PLAN.md`; authoritative source is the
