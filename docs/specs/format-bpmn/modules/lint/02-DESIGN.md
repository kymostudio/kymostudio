...
| Owner        | `packages/python` (kymo CLI)                                        |
| Related      | FEAT-BPMN-LINT-001, TEST-BPMN-LINT-001, PLAN-BPMN-LINT-001, DESIGN-BPMN-PARSER-001 |
...
Version-controlled at `docs/specs/format-bpmn/modules/lint/02-DESIGN.md`; the authoritative source is the
