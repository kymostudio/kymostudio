...
| Owner        | `diagrams/` project                                |
| Related      | FEAT-BPMN-ANIMATE-001, DESIGN-BPMN-ANIMATE-001, PLAN-BPMN-ANIMATE-001, KYMOANIM-MAP-001 |
...
Version-controlled at `docs/specs/format-bpmn/modules/animate/03-TEST.md`; authoritative source is the main-branch
