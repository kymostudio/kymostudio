...
Increments and any later changes to the baselined spec (`docs/specs/format-bpmn/modules/animate/`) are raised,
...
Version-controlled at `docs/specs/format-bpmn/modules/animate/04-PLAN.md`; authoritative source is the main-branch
