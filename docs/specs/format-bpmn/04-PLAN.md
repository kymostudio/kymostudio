...
| 0.2     | 2026-06-13 | Vũ Anh | Folder renamed `docs/specs/bpmn/` → `docs/specs/format-bpmn/` (format-family prefix). All `*-BPMN-001` document_ids and the "BPMN Support" titles unchanged; self-referential paths in the family's Annex B.1 / change-control sections and the two external READMEs (`packages/python/spikes/`, `benches/bpmn/`) updated to the new path. |

## Annex B — Document Control

### B.1 Storage and Retrieval
Version-controlled at `docs/specs/format-bpmn/04-PLAN.md`; authoritative source is the main-branch working
