...
> **What this folder is.** `CR-004/` is a **self-contained mini engineering-spec** mirroring the parent
...
| Clause | Doc | Change |
|--------|-----|--------|
| §3.2 / §6 | `FEAT-BPMN-EDITOR-001` | Add copy/paste/duplicate + keyboard modeling; drop them from out-of-scope |
