...
| Status            | **Proposed** |
| Owner             | `diagrams/` project |
| Related Documents | `INTRO-BPMN-EDITOR-CR-001` (change record), `DESIGN-BPMN-EDITOR-CR-001` (how), `TEST-BPMN-EDITOR-CR-001` (V&V), `FEAT-BPMN-EDITOR-001` (the SRS this amends), `PROD-BPMN-EDITOR-001` (stakeholder needs) |
...
CR-001 serves the existing `bpmn-editor` stakeholder needs (`PROD-BPMN-EDITOR-001`), extended to
collaboration:
