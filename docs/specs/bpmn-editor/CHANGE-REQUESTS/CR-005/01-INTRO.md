...
> **What this folder is.** `CR-005/` is a **self-contained mini engineering-spec** mirroring the parent
...
| Clause | Doc | Change |
|--------|-----|--------|
| §3.1 / §6 | `FEAT-BPMN-EDITOR-001` | Add the auto-layout action; drop auto-layout from out-of-scope |
