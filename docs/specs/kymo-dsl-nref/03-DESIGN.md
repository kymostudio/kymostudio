...
| Owner        | `diagrams/` project                                |
| Related      | INTRO-KYMO-NREF-001, FEAT-KYMO-NREF-001, TEST-KYMO-NREF-001, PLAN-KYMO-NREF-001 |
...
Version-controlled at `docs/specs/kymo-dsl-nref/03-DESIGN.md`; authoritative source
