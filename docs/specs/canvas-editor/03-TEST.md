...
| TC-19 | E2E | FR-CE-10 (robustness) | §7, RK-07 | The BPMN single-embed renders as an `<img>` data-URL; pan it off-screen (tldraw culls it) → pan back → it reappears decoded (`img.complete`, `naturalWidth > 0`) with no blank flash. |
