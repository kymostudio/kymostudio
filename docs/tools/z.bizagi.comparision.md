...
These follow from the comparison and the borrowable ideas catalogued in [`bizagi.md`](z.bizagi.md):
...
- Factual basis for the Bizagi column: [`bizagi.md`](z.bizagi.md).
