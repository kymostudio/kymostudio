...
const KY = { flowchart: core.mermaidToSvg, sequence: core.mermaidSequenceToSvg, state: core.mermaidStateToSvg, class: core.mermaidClassToSvg, er: core.mermaidErToSvg, block: core.mermaidBlockToSvg, mindmap: core.mermaidMindmapToSvg, kanban: core.mermaidKanbanToSvg, requirement: core.mermaidRequirementToSvg };
...
const summary = {};
for (const g of ["flowchart", "sequence", "state", "class", "er", "block", "mindmap", "kanban", "requirement"]) {
  const files = [];
