...
size and commit the result as `datasets/resvg-suite/refs/<category>/<name>.png`.
These are the ground truth the accuracy bench scores every engine against (kymo
...
Run:  uv run python svg2png/gen_refs.py [--chrome /path/to/chrome] [--limit N]
"""
...
_HTML = (
    ...
    "background:#fff;overflow:hidden}}</style></head><body>{svg}</body></html>"
)
