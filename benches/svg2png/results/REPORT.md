...
|---|---|---|---|---|---|---|---|---|---|
| kymo | `resvg (kymostudio-core 0.3.6)` | 30/30 | 30/30 | — | — | 11.274 | 58.9 | ×1.0 | **reference** |
| resvg-py | `resvg (0.3.2)` | 30/30 | 30/30 | 0.0 | 0.0% | 19.079 | 32.6 | ×0.55 | **pixel-identical** |
| pyvips | `librsvg (via libvips 8.15.1)` | 30/30 | 30/30 | 0.24 | 4.07% | 15.465 | 18.7 | ×0.32 | **high fidelity** |
| cairosvg | `Cairo (2.9.0)` | 30/30 | 30/30 | 11.24 | 99.73% | 7.347 | 106.5 | ×1.81 | **low fidelity** |
...
- Timing is host-specific (`Linux-6.8.0-117-generic-x86_64-with-glibc2.39`, Python 3.13.13,
  4 CPU, reps=7, 2026-06-06T12:34:33+00:00).
